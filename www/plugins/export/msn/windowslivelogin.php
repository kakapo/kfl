...
class WindowsLiveLogin
{
    ...
    public static function initFromXml($settingsFile)
    {
		...
		if(!isset($settings['force_delauth_nonprovisioned'])) $settings['force_delauth_nonprovisioned']="false";
		...
		if(!isset($settings['oldsecret'])) $settings['oldsecret']="";
		if(!isset($settings['oldsecretexpiry'])) $settings['oldsecretexpiry']="";
		if(!isset($settings['baseurl'])) $settings['baseurl']="";
		if(!isset($settings['secureurl'])) $settings['secureurl']=""; 
		if(!isset($settings['baseurl'])) $settings['baseurl']="";
		if(!isset($settings['consenturl'])) $settings['consenturl']="";
