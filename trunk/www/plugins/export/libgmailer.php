...
/* 		$this->gmail_data = GMailer::execute_curl(GM_LNK_LOGIN, GM_LNK_REFER, 'post', $postdata, 'nocookie', ""); */
		$this->gmail_data = GMailer::execute_curl(GM_LNK_LOGIN, GM_LNK_LOGIN_REFER, 'post', $postdata, 'nocookie', "");
/* 		$this->gmail_data = GMailer::execute_curl(GM_LNK_LOGIN, $referrer, 'post', $postdata, 'cookie', 'GMAIL_LOGIN=T1144143890812/1144143890812/1144143969031'); */
...
/* 		$ret = GMailer::execute_curl($forward, GM_LNK_REFER, 'post', $postdata, "cookie", $cookies); */
		...
		$ret = GMailer::execute_curl($forward, GM_LNK_LOGIN_REFER, 'get', "", "cookie", "GoogleAccountsLocale_session=en; ".$cookies);
		
		$data = GMailer::get_cookies($ret);
/* 		Debugger::say("second phase: ".print_r($ret,true)); */
/* 		print_r($data); */
		$d = ($data) ? $data : $cookies;
...
/* 		Debugger::say("header: ".print_r($header,true)."\n\ncookies: ".print_r($match,true));  */
		...
		foreach ($match[1] as $val) {
			...
			if (strpos($val,"EXPIRED") !== false) continue;
			$cookie .= $val . ";";
		}
